#
#  Be sure to run `pod spec lint KYVedioPlayer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of KYVedioPlayer."
  ...
  s.homepage     = "http://EXAMPLE/KYVedioPlayer"
  ...
  s.author             = { "kingly" => "kingly09@gmail.com" }
  # Or just: s.author    = "kingly"
  # s.authors            = { "kingly" => "kingly09@gmail.com" }
  # s.social_media_url   = "http://twitter.com/kingly"
  ...
  s.source       = { :git => "http://EXAMPLE/KYVedioPlayer.git", :tag => "0.0.1" }
